...
Gem::Specification.new do |s|
  ...
  ## as you like.
  s.summary     = "Unambiguously, compactly and clearly describe font in CSS"
  s.description = <<END 
Font Variation Description addresses the need to describe a font in CSS by
way of its font descriptions such as font-style and font-weight.
END
  ...
  s.homepage = 'http://github.com/typekit/fontvariationdescription'
